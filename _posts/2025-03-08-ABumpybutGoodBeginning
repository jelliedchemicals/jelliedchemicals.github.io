...
- `find` most powerful and flexible of the search utilities. You can begin your search in any designated directory and can look for filename, date of creation or modification, the owner, group, permissions, and the size.
...
- **cat**: obviously displays the contents of a file, but adding **>** creates a file with the filename you follow it with
	- **cat >** hackingskills - this would create a file called hacking skills. Exit the created file with **ctrl+d**
...
- I've used Snort previously in a Black Hills Information Security SOC skills class and TryHackMe rooms. I'll be exc'm practicing them in rather than the intended Kali environment.ited to go back to it and use it more.
...
- **less**: less is the same as more, but with more functionality. Scroll through one page at a time but you can also filter for terms
